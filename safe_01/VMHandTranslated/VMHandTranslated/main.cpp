...
uint64_t VMFunc(char* Flag) {
	...
	uint64_t BB_004002CE_P0;
	uint64_t BB_004002CE_P1;
...
//_00400279:		S1 = DW_OP_deref_size(5, S5);
	S5 = Flag[32];
...
_0040027E:		S5 = S1;//DW_OP_pick(3); // 1 FLAG_0
_00400280:		S6 = S2;//DW_OP_pick(3); // 2 FLAG_1
	BB_004002CE_P0 = S1;
	BB_004002CE_P1 = S2;
...
_004002D1:		S9 = BB_004002CE_P0; //DW_OP_pick(5); // 3
_004002D3:		S10 = BB_004002CE_P1; //DW_OP_pick(5); // 4
//_004002D5:		DW_OP_skip(0x00000033); // (0x0040030B)
	goto _0040030B;



_004002D8:		S11 = DW_OP_pick(4); // 6
_004002DA:		S12 = DW_OP_pick(4); // 7
...
_00400341:		S14 = DW_OP_dup(S13);
_00400342:		DW_OP_rot(S14, S13, S12);
_00400343:		S15 = DW_OP_pick(4); // 10
...
_0040034E:		S14 = DW_OP_pick(3); // 10
_00400350:		S13 = DW_OP_and(S13, S14);
_00400351:		DW_OP_swap(S13, S12);
_00400352:		S14 = DW_OP_dup(S13);
_00400353:		S15 = DW_OP_pick(4); // 10
...
_004003AC:		S14 = DW_OP_pick(2); // 11
_004003AE:		S15 = DW_OP_pick(5); // 9
_004003B0:		S16 = DW_OP_pick(5); // 10
...
_004003D2:		S16 = DW_OP_pick(3); // 12
_004003D4:		S17 = DW_OP_lit(00);
_004003D5:		DW_OP_swap(S17, S16);
_004003D6:		S18 = DW_OP_dup(S17);
...
_004003F2:		S18 = DW_OP_pick(4); // 13
_004003F4:		S19 = DW_OP_dup(S18);
...
_00400438:		S18 = DW_OP_pick(4); // 13
_0040043A:		S19 = DW_OP_dup(S18);
...
_004004B6:		S20 = DW_OP_pick(2); // 17
_004004B8:		S19 = DW_OP_xor(S19, S20);
_004004B9:		S20 = DW_OP_dup(S19);
...
_004004C9:		S20 = DW_OP_pick(3); // 16
_004004CB:		S19 = DW_OP_xor(S19, S20);
_004004CC:		S20 = DW_OP_pick(2); // 17
_004004CE:		S19 = DW_OP_xor(S19, S20);
_004004CF:		S20 = DW_OP_dup(S19);
...
_004004F9:		S4 = DW_OP_deref_size(21, S21);
...
_004005A0:		S4 = DW_OP_deref_size(21, S21);
_004005A2:		S22 = DW_OP_pick(4); // 17
_004005A4:		S21 = DW_OP_xor(S21, S22);
_004005A5:		S22 = DW_OP_pick(3); // 18
...
_004005B3:		S23 = DW_OP_dup(S22);
_004005B4:		S24 = DW_OP_pick(4); // 19
_004005B6:		S23 = DW_OP_xor(S23, S24);
_004005B7:		S24 = DW_OP_pick(3); // 20
_004005B9:		S25 = DW_OP_dup(S24);
...
_004005CA:		S25 = DW_OP_dup(S24);
_004005CB:		S26 = DW_OP_pick(4); // 21
...
_004005F0:		S27 = DW_OP_pick(2); // 24
_004005F2:		S26 = DW_OP_xor(S26, S27);
_004005F3:		S27 = DW_OP_pick(3); // 23
_004005F5:		S26 = DW_OP_xor(S26, S27);
_004005F6:		S27 = DW_OP_pick(4); // 22
_004005F8:		S28 = DW_OP_pick(4); // 23
...
_00400AE7:		S27 = DW_OP_dup(S26);
_00400AE8:		S28 = DW_OP_dup(S27);
...
_00400B0E:		S27 = DW_OP_dup(S26);
_00400B0F:		S28 = DW_OP_dup(S27);
...
_00400B25:		S27 = DW_OP_dup(S26);
_00400B26:		S28 = DW_OP_dup(S27);
...
_00400B52:		S27 = DW_OP_dup(S26);
_00400B53:		S28 = DW_OP_dup(S27);
...
_00400B90:		S27 = DW_OP_dup(S26);
_00400B91:		S28 = DW_OP_dup(S27);
...
_00400C03:		S27 = DW_OP_dup(S26);
_00400C04:		S28 = DW_OP_dup(S27);
...
_00400C1A:		S27 = DW_OP_dup(S26);
_00400C1B:		S28 = DW_OP_dup(S27);
...
_00400C57:		S27 = DW_OP_dup(S26);
_00400C58:		S28 = DW_OP_dup(S27);
...
_00400C6E:		S27 = DW_OP_dup(S26);
_00400C6F:		S28 = DW_OP_dup(S27);
...
_00400C97:		S27 = DW_OP_dup(S26);
_00400C98:		S28 = DW_OP_dup(S27);
...
_00400CF8:		S27 = DW_OP_dup(S26);
_00400CF9:		S28 = DW_OP_dup(S27);
...
_00400D64:		S27 = DW_OP_dup(S26);
_00400D65:		S28 = DW_OP_dup(S27);
...
_00400D84:		S29 = DW_OP_dup(S28);
_00400D85:		S30 = DW_OP_dup(S29);
...
_00400D95:		S29 = DW_OP_dup(S28);
_00400D96:		S30 = DW_OP_dup(S29);
...
_00400DAC:		S29 = DW_OP_dup(S28);
_00400DAD:		S30 = DW_OP_dup(S29);
...
_00400DFD:		S29 = DW_OP_dup(S28);
_00400DFE:		S30 = DW_OP_dup(S29);
...
_00400E20:		S29 = DW_OP_dup(S28);
_00400E21:		S30 = DW_OP_dup(S29);
...
_00400EBB:		S27 = DW_OP_dup(S26);
_00400EBC:		S28 = DW_OP_dup(S27);
...
_00400EED:		S27 = DW_OP_dup(S26);
_00400EEE:		S28 = DW_OP_dup(S27);
...
_00400F0F:		S27 = DW_OP_dup(S26);
_00400F10:		S28 = DW_OP_dup(S27);
...
_00400F26:		S27 = DW_OP_dup(S26);
_00400F27:		S28 = DW_OP_dup(S27);
...
_00400F4C:		S27 = DW_OP_dup(S26);
_00400F4D:		S28 = DW_OP_dup(S27);
...
_00400F72:		S27 = DW_OP_dup(S26);
_00400F73:		S28 = DW_OP_dup(S27);
...
_00400FAE:		S27 = DW_OP_dup(S26);
_00400FAF:		S28 = DW_OP_dup(S27);
...
_00400FD5:		S27 = DW_OP_dup(S26);
_00400FD6:		S28 = DW_OP_dup(S27);
...
_00401007:		S27 = DW_OP_dup(S26);
_00401008:		S28 = DW_OP_dup(S27);
...
_00401046:		S27 = DW_OP_dup(S26);
_00401047:		S28 = DW_OP_dup(S27);
...
_00401057:		S27 = DW_OP_dup(S26);
_00401058:		S28 = DW_OP_dup(S27);
...
_00401077:		S27 = DW_OP_dup(S26);
_00401078:		S28 = DW_OP_dup(S27);
...
_004010B5:		S27 = DW_OP_dup(S26);
_004010B6:		S28 = DW_OP_dup(S27);
...
_004010ED:		S27 = DW_OP_dup(S26);
_004010EE:		S28 = DW_OP_dup(S27);
...
_0040111A:		S27 = DW_OP_dup(S26);
_0040111B:		S28 = DW_OP_dup(S27);
...
_0040112B:		S27 = DW_OP_dup(S26);
_0040112C:		S28 = DW_OP_dup(S27);
...
_0040115D:		S27 = DW_OP_dup(S26);
_0040115E:		S28 = DW_OP_dup(S27);
...
_00401183:		S27 = DW_OP_dup(S26);
_00401184:		S28 = DW_OP_dup(S27);
...
_004011B9:		S27 = DW_OP_dup(S26);
_004011BA:		S28 = DW_OP_dup(S27);
...
_004011D0:		S27 = DW_OP_dup(S26);
_004011D1:		S28 = DW_OP_dup(S27);
...
_004011E1:		S27 = DW_OP_dup(S26);
_004011E2:		S28 = DW_OP_dup(S27);
...
_00401257:		S27 = DW_OP_dup(S26);
_00401258:		S28 = DW_OP_dup(S27);
...
_00401274:		S27 = DW_OP_dup(S26);
_00401275:		S28 = DW_OP_dup(S27);
...
_004012A1:		S27 = DW_OP_dup(S26);
_004012A2:		S28 = DW_OP_dup(S27);
...
_004012E6:		S27 = DW_OP_dup(S26);
_004012E7:		S28 = DW_OP_dup(S27);
...
_004012FD:		S27 = DW_OP_dup(S26);
_004012FE:		S28 = DW_OP_dup(S27);
...
_00401314:		S27 = DW_OP_dup(S26);
_00401315:		S28 = DW_OP_dup(S27);
...
_00401325:		S27 = DW_OP_dup(S26);
_00401326:		S28 = DW_OP_dup(S27);
...
_00401361:		S27 = DW_OP_dup(S26);
_00401362:		S28 = DW_OP_dup(S27);
...
_00401397:		S27 = DW_OP_dup(S26);
_00401398:		S28 = DW_OP_dup(S27);
...
_004013C4:		S27 = DW_OP_dup(S26);
_004013C5:		S28 = DW_OP_dup(S27);
...
_00401417:		S27 = DW_OP_dup(S26);
_00401418:		S28 = DW_OP_dup(S27);
...
_0040143D:		S27 = DW_OP_dup(S26);
_0040143E:		S28 = DW_OP_dup(S27);
...
_00401454:		S27 = DW_OP_dup(S26);
_00401455:		S28 = DW_OP_dup(S27);
...
_0040148B:		S27 = DW_OP_dup(S26);
_0040148C:		S28 = DW_OP_dup(S27);
...
_004014E3:		S27 = DW_OP_dup(S26);
_004014E4:		S28 = DW_OP_dup(S27);
...
_004014FA:		S27 = DW_OP_dup(S26);
_004014FB:		S28 = DW_OP_dup(S27);
...
_00401517:		S27 = DW_OP_dup(S26);
_00401518:		S28 = DW_OP_dup(S27);
...
_0040156A:		S27 = DW_OP_dup(S26);
_0040156B:		S28 = DW_OP_dup(S27);
...
_004015A2:		S27 = DW_OP_dup(S26);
_004015A3:		S28 = DW_OP_dup(S27);
...
_004015C5:		S27 = DW_OP_dup(S26);
_004015C6:		S28 = DW_OP_dup(S27);
...
_004015DC:		S27 = DW_OP_dup(S26);
_004015DD:		S28 = DW_OP_dup(S27);
...
_004015FF:		S27 = DW_OP_dup(S26);
_00401600:		S28 = DW_OP_dup(S27);
...
_0040165D:		S27 = DW_OP_dup(S26);
_0040165E:		S28 = DW_OP_dup(S27);
...
_00401684:		S27 = DW_OP_dup(S26);
_00401685:		S28 = DW_OP_dup(S27);
...
_004016B6:		S27 = DW_OP_dup(S26);
_004016B7:		S28 = DW_OP_dup(S27);
...
_0040170A:		S27 = DW_OP_dup(S26);
_0040170B:		S28 = DW_OP_dup(S27);
...
_00401721:		S27 = DW_OP_dup(S26);
_00401722:		S28 = DW_OP_dup(S27);
...
_00401732:		S27 = DW_OP_dup(S26);
_00401733:		S28 = DW_OP_dup(S27);
...
_00401766:		S27 = DW_OP_dup(S26);
_00401767:		S28 = DW_OP_dup(S27);
...
_00401788:		S27 = DW_OP_dup(S26);
_00401789:		S28 = DW_OP_dup(S27);
...
_0040179F:		S27 = DW_OP_dup(S26);
_004017A0:		S28 = DW_OP_dup(S27);
...
_004017BB:		S27 = DW_OP_dup(S26);
_004017BC:		S28 = DW_OP_dup(S27);
...
_004017CC:		S27 = DW_OP_dup(S26);
_004017CD:		S28 = DW_OP_dup(S27);
...
_004017E3:		S27 = DW_OP_dup(S26);
_004017E4:		S28 = DW_OP_dup(S27);
...
_004017FF:		S27 = DW_OP_dup(S26);
_00401800:		S28 = DW_OP_dup(S27);
...
_0040186E:		S27 = DW_OP_dup(S26);
_0040186F:		S28 = DW_OP_dup(S27);
...
_00401891:		S27 = DW_OP_dup(S26);
_00401892:		S28 = DW_OP_dup(S27);
...
_004018A8:		S27 = DW_OP_dup(S26);
_004018A9:		S28 = DW_OP_dup(S27);
...
_004018E6:		S27 = DW_OP_dup(S26);
_004018E7:		S28 = DW_OP_dup(S27);
...
_004018FD:		S27 = DW_OP_dup(S26);
_004018FE:		S28 = DW_OP_dup(S27);
...
_00401947:		S27 = DW_OP_dup(S26);
_00401948:		S28 = DW_OP_dup(S27);
...
_0040196F:		S27 = DW_OP_dup(S26);
_00401970:		S28 = DW_OP_dup(S27);
